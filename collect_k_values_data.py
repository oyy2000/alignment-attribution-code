...
def collect_data_for_sparsity(sparsity_ratio: float) -> Dict:
    ...
    base_dir = "out/llama2-7b-chat-hf/unstructured/wanda_3_set_difference_weightonly_100/GSM8K_cot0shot_120/prompt_direct,cot0shot,cot0shot_goldreason/"
...
def plot_results(all_results: Dict[float, Dict]):
    ...
    plt.tight_layout()
    plt.savefig('sparsity_ratios_analysis.png', dpi=300, bbox_inches='tight')
    plt.show()
    ...
    with open('sparsity_ratios_detailed_results.json', 'w') as f:
        json.dump(all_results, f, indent=2)
    
    print(f"\nDetailed results saved to: sparsity_ratios_detailed_results.json")
    print(f"Plot saved to: sparsity_ratios_analysis.png")
