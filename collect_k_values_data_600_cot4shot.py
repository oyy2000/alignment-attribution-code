...
def collect_data_for_sparsity(sparsity_ratio: float) -> Dict:
    ...
    pruned_cot_goldreason_prompt_file = f"{target_sparsity_dir}gsm8k_bottom_{target_sparsity_value}_direct,cot4shot_selected_samples_prompt_cot4shot.jsonl"
    pruned_direct_prompt_file = f"{target_sparsity_dir}gsm8k_bottom_{target_sparsity_value}_direct,cot4shot_selected_samples_prompt_direct.jsonl"
...
def main():
    ...
    sparsity_ratios = [0.003151, 0.008161, 0.018615, 0.034472, 0.052438, 0.068083]
    all_results = {}
    ...
    # Then collect data for different sparsity ratios
    for sparsity_ratio in sparsity_ratios:
