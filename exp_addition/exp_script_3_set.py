...
nsamples = 600
eval_type = "all"
log_file = f"command_log_eval_Addition:6_wanda_2_set_utility_50_pq.json"
def build_command(prune_method, prompt_method, p, q, k, u):
    save_dir = f"/common/users/sl2148/Public/yang_ouyang/alignment-attribution-code/out/{eval_dataset}/{model}/{sparsity_type}/{prune_method}_{suffix}/{set_difference_data}/eval_{eval_type}/prompt_{prompt_method}/step_0.01_sp_{sparsity_threshold}_k_0.01/pq_{p}_{q}_k_{k}_u_{u}/"
