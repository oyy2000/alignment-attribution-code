...
eval_type = "all"
prune_data = "gsm8k"
log_file = f"command_log_eval_gsm8k_wanda_3_set_454_alpaca_cleaned_no_safety_pquk_grid_search_[round(0.01 * i, 2) for i in range(1, 50)]_step_0.01_sp_{sparsity_threshold}.json"
def build_command(prune_method, prompt_method, p, q, k, u):
    save_dir = f"/common/users/sl2148/Public/yang_ouyang/alignment-attribution-code/out/{eval_dataset}/{model}/{sparsity_type}/{prune_method}_{suffix}/wanda_3_set_difference_cot0shot/eval_{eval_type}/prompt_{prompt_method}/step_0.01_sp_{sparsity_threshold}_k_0.01/pq_{p}_{q}_k_{k}_u_{u}/"
    command = (
        f"python ../main.py "
