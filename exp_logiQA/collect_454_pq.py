...
ORIG_COT4_FILE = (
    f"/common/users/sl2148/Public/yang_ouyang/alignment-attribution-code/out/{dataset}/llama2-7b-chat-hf/direct,cot0shot/eval_all/{dataset}_bottom_0.000000_direct,cot0shot_all_prompt_cot0shot.jsonl"
)
ORIG_DIRECT_FILE = (
    f"/common/users/sl2148/Public/yang_ouyang/alignment-attribution-code/out/{dataset}/llama2-7b-chat-hf/direct,cot0shot/eval_all/{dataset}_bottom_0.000000_direct,cot0shot_all_prompt_direct.jsonl"
)
